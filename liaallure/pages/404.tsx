        ...
        <>
            ...
            {/* Your HTML content goes here */}
                <div className="Notfound_container___vm_Q">
                    <Img style={PaddingBottom} width="500" height="500"src="https://cdn.lynnux.xyz/assets/svg/NotFound.svg" alt="not-found" className="Notfound_not-found-img__st0se" priority={true}/>
